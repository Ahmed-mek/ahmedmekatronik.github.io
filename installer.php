...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211231_ikonel_net_firist_virsion_6ff7832f724e26c81723_20211231084408_archive.zip';
	const ARCHIVE_SIZE		 = '481210418';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '6ff7832-31084408';
    const SECONDARY_PACKAGE_HASH = '52533db-31084408';
	const VERSION			 = '1.4.3';
